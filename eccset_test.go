...
func Test_ed25519_ref10(t *testing.T) {
	...
	pub, ret := GenPubkey(pri, ECC_CURVE_ED25519_REF10)
	if ret != SUCCESS {
	...
	pass := Verify(pub, nil, 0, data, 55, sig, ECC_CURVE_ED25519_REF10)
	...
	pass = Verify(pub, nil, 0, data[:54], 54, sig, ECC_CURVE_ED25519_REF10)
	if pass != 0 {
		t.Error("verify failed!")
	} else {
		fmt.Println("success!")
