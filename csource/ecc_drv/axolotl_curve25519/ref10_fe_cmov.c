...
void REF10_fe_cmov(REF10_fe f,const REF10_fe g,unsigned int b)
{
  ...
  REF10_crypto_int32 x0 = f0 ^ g0;
  REF10_crypto_int32 x1 = f1 ^ g1;
  REF10_crypto_int32 x2 = f2 ^ g2;
  REF10_crypto_int32 x3 = f3 ^ g3;
  REF10_crypto_int32 x4 = f4 ^ g4;
  REF10_crypto_int32 x5 = f5 ^ g5;
  REF10_crypto_int32 x6 = f6 ^ g6;
  REF10_crypto_int32 x7 = f7 ^ g7;
  REF10_crypto_int32 x8 = f8 ^ g8;
  REF10_crypto_int32 x9 = f9 ^ g9;
  b = -b;
  x0 &= b;
  x1 &= b;
  x2 &= b;
