...
{
  REF10_ge_p3 ed_pubkey_point; /* Ed25519 pubkey point */
  ...
  REF10_ge_p3_tobytes(ed_pubkey, &ed_pubkey_point);
  sign_bit = ed_pubkey[31] & 0x80;

  /* Perform an Ed25519 signature with explicit private key */
  REF10_crypto_sign_modified(sigbuf, msg, msg_len, curve25519_privkey,
                       ed_pubkey, random);
                      ...
                      const unsigned char* msg, const unsigned long msg_len)
{
  ...
  */
  ...
  result = REF10_crypto_sign_open_modified(verifybuf2, verifybuf, 64 + msg_len, ed_pubkey);
